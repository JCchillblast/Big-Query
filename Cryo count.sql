WITH filtered_events AS (
  ...
  WHERE DATE BETWEEN '2025-12-02' AND '2025-12-05'            -- partition filter required
    ...
    AND (
          ...
          OR item__id LIKE '%_CBB-CHILLBLAST'   -- matches ALL CBB variants
        )
),
...
SELECT
  CASE 
    WHEN item__id LIKE '%_CBB-CHILLBLAST' THEN '_CBB-CHILLBLAST'
    ELSE item__id
  END AS item_group,
